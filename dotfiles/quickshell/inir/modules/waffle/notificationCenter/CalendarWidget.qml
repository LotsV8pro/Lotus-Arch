...
BodyRectangle {
    ...
    function getSelectedDayEvents(): var {
        ...
        const externalEvents = Events.filterExternalDuplicates(localEvents,
                CalendarSync.getEventsForDate(root.selectedDate) || [])
    ...
    function getUpcomingEvents(): var {
        ...
        for (let dayOffset = 0; dayOffset < 3; dayOffset++) {
            ...
            const externalEvents = Events.filterExternalDuplicates(localEvents,
                (CalendarSync.getEventsForDate(date) || []).map(e => Object.assign({}, e, {
                    _dayOffset: dayOffset
                })))
