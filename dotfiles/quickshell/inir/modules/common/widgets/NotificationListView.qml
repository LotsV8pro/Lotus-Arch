...
StyledListView { // Scrollable window
    ...
    model: ScriptModel {
        values: root.popup
            ? (root.popupAppNames ?? Notifications.popupAppNameList)
            : Notifications.appNamesMatching(root.filterQuery)
    }
    property var popupAppNames: null
    property var popupGroups: null
    delegate: NotificationGroup {
        ...
        notificationGroup: popup ?
            (root.popupGroups ?? Notifications.popupGroupsByAppName)[modelData] :
