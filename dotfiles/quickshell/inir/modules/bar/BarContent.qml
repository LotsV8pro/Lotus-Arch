...
Item { // Bar content region
    ...
    readonly property var _rightIds:       root._zone("right",       ["rightSidebarButton", "tray", "timer", "shellUpdate", "systemUpdate", "spacer", "weather"])
    ...
    Component { id: systemUpdateComponent; SystemUpdateIndicator { Layout.alignment: Qt.AlignVCenter } }
    Component {
        id: spacerComponent
        Item {
