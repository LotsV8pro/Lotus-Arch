        ...
        SettingsGroup {
            ...
            StyledText {
                ...
                text: CompositorService.isNiri
                    ? Translation.tr("This project is a fork of end-4's illogical-impulse, adapted for the Niri compositor.")
                    : Translation.tr("This project is a fork of end-4's illogical-impulse, adapted for the Hyprland compositor.")
                color: Appearance.colors.colSubtext
                font.pixelSize: Appearance.font.pixelSize.small
