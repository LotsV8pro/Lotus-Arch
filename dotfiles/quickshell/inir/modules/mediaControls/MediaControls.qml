...
Scope {
    ...
    readonly property bool visualizerActive: root._presentedOpen && MprisController.isPlaying
    ...
    Loader {
        ...
        sourceComponent: Variants {
            ...
            PanelWindow {
                ...
                Component.onCompleted: mediaControlsRoot.visible = GlobalStates.mediaControlsOpen
                ...
                Connections {
                    ...
                    function onMediaControlsOpenChanged() {
                        if (GlobalStates.mediaControlsOpen) {
                            ...
                            mediaControlsRoot.visible = true
                        } else {
                ...
                Timer {
                    ...
                    interval: Math.max(300, Appearance.animation.elementMoveFast.duration + Appearance.animation.elementMoveExit.duration + 50)
                    onTriggered: mediaControlsRoot.visible = false
                }
