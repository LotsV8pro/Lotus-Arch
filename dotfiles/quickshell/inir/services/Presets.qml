...
Singleton {
    ...
    FolderListModel {
        ...
        folder: Qt.resolvedUrl(`file://${Directories.userPresetsPath}`)
        showDirs: false
        nameFilters: ["*.json"]
    }
    ...
    FolderListModel {
        ...
        folder: Qt.resolvedUrl(`file://${Directories.cachePath}/quickshell/presets`)
        showDirs: false
        nameFilters: ["*.json"]
    }
    ...
    FolderListModel {
        ...
        folder: Qt.resolvedUrl(`file://${Directories.cachePath}/quickshell/presets_imported`)
        showDirs: false
        nameFilters: ["*.json"]
    }
    ...
    function ensureInitial(name, description) {
        ensureInitialProc.command = ["bash", Directories.presetsScriptPath, "--ensure-initial", name, description]
        ensureInitialProc.running = true
    }
