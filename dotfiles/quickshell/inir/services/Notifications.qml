...
Singleton {
    ...
    // hours and GameMode are derived policy; callers can explain the real cause
    // without making a temporary game suppression look like DND was switched on.
    ...
    readonly property string notificationPolicyReason: manualDndActive ? "dnd"
        ...
        : ""
    // Popups show even while the right sidebar (notification surface) is open:
    // only DND/quiet hours/GameMode inhibit them.
    readonly property bool popupInhibited:
        notificationPolicyActive
