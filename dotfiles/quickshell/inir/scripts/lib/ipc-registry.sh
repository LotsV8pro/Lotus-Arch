...
declare -gA IPC_TARGET_FUNCTIONS=(
  ...
  [closeConfirm]="trigger triggerWindow triggerAddress close"
...
declare -gA IPC_FUNCTION_DESC=(
  ...
  ["closeConfirm:triggerAddress"]="Close or confirm the window identified by its Hyprland address"
...
declare -gA IPC_FUNCTION_ARGS=(
  ...
  ["closeConfirm:triggerAddress"]="<address> <appId>"
