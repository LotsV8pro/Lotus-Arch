                ...
                Item {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            height: 40
                            radius: 10
                            // Lotus-Arch contrast patch: upstream used Colors.color3
                            // (bright accent) behind light labels — unreadable on
                            // blue/bright palettes. Dark base keeps text legible.
                            color: Dat.Colors.color0
                            border.color: bladeHoverHandler.hovered ? Dat.Colors.foreground : Dat.Colors.color4
