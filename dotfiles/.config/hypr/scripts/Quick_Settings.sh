...
# Read $term from 01-UserDefaults.lua
config_file="$HOME/.config/hypr/UserConfigs/01-UserDefaults.lua"

# Extract $term value from lua file
...
main() {
    ...
    case "$choice" in
        ...
        "Edit User Settings") file="$UserConfigs/UserSettings.lua"; show_info "Editing user settings." ;;
